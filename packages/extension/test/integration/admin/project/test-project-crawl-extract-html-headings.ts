...
const crawlDefinitions: ICrawlDefinition[] = [
  {
    ...
    expectedCsv: [
      ...
      '"https://www.sitea.com/static/pageA.html","PageA Heading Level 1"',
      '"https://www.sitea.com/static/pageA.html","PageA Heading Level 2"',
      '"https://www.sitea.com/static/pageB.html","PageB Heading Level 1"',
      '"https://www.sitea.com/static/pageB.html","PageB Heading Level 3"',
    ],
    csvLineSeparator: '\n',
  },
];
